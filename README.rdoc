...
Designed for use by the PLC Sydney Mathematics Department, and not likely to be
useful to anyone else!  The general idea may be of interest, though.
...
I create webpages in Moodle as part of my job.  Certain aspects of doing this are
extremely annoying.  This project allows me to turn plain text files (with
certain layout and formatting rules observed) into HTML that I can copy into
Moodle (or insert directly into the database).
